...
class cmfSegDataset(BaseDataset):
    def initialize(self, opt):
        self.opt = opt
        self.root = opt.dataroot

        self.dir_A = opt.CT_dir
        self.dir_B = opt.MRI_dir
        self.dir_Seg = opt.SEG_dir
    ...
    def __getitem__(self, index):
        ...
        Seg_imgs = torch.Tensor(self.opt.output_nc_seg, Seg_img.size()[1], Seg_img.size()[2])
